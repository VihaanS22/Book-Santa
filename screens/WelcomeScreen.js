      ...
      return Alert.alert("password doesn't match.Check your password.") }
        ...
        .then(()=>{ 
          ...
          .catch((error)=> { // Handle Errors here. 
            var errorCode = error.code; var errorMessage = error.message; return Alert.alert(errorMessage) 
          }); }
...
onChangeText={(text)=>{ 
  this.setState({ address: text }) }}
   ...
   <TextInput style={styles.formTextInput} placeholder ={"Email"} keyboardType ={'email-address'} 
   onChangeText={(text)=>{ 
